...
<section class="mm-page-hero">
  <div class="mm-container">
    ...
    <div class="mm-actions">
      <a class="mm-btn mm-btn--primary" href="{{ '/human-care/psychologists/' | relative_url }}">Talk to a Psychologist</a>
    </div>
  </div>
</section>
...
<section class="mm-section mm-section--cta">
  <div class="mm-container">
    <div class="mm-cta-panel">
      <div>
        <span class="mm-eyebrow">Human support</span>
        <h2>Find the right kind of human support.</h2>
        <p>Explore psychologists, psychiatrists or corporate counselling within the Human Care section.</p>
      </div>
      <div class="mm-actions">
        <a class="mm-btn mm-btn--primary" href="{{ '/human-care/psychologists/' | relative_url }}">Meet Psychologists</a>
        <a class="mm-btn mm-btn--ghost" href="{{ '/human-care/psychiatrists/' | relative_url }}">Explore Psychiatrists</a>
      </div>
    </div>
  </div>
</section>
