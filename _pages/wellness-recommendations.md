...
<section class="mm-section">
  <div class="mm-container">
    ...
    <div class="mm-split mm-ai-benefit-split">
      <div><span class="mm-eyebrow">A feedback loop</span><h2>Recommend → practise → check in → learn.</h2><p>A recommendation becomes more useful when you can choose whether to try it, reflect on the result and build a better understanding of what works for you over time. A tool should not be forced or repeated simply to chase a score.</p></div>
      <aside class="mm-ai-explainer"><span aria-hidden="true">{% include mm-icon.html name="users" %}</span><h3>Human escalation</h3><p>Technology should not try to handle everything. When needs are complex, persistent or clinically significant, the experience should guide the person toward appropriate psychologists, psychiatrists or other professional support.</p></aside>
    </div>
