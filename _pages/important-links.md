...
<section class="mm-section mm-section--tight">
  <div class="mm-container">
    <div class="mm-resource-link-grid">
      ...
      <a class="mm-resource-link" href="{{ '/contact/' | relative_url }}"><span>{% include mm-icon.html name="phone-call" %}</span><div><h2>Contact Mente Mirror</h2><p>WhatsApp, phone and email for programme questions and routine enquiries. Appointment booking is handled in the mobile app.</p></div></a>
