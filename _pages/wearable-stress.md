...
<section class="mm-section">
  <div class="mm-container mm-ai-detail-layout">
    ...
    <aside class="mm-ai-explainer"><span aria-hidden="true">{% include mm-icon.html name="sparkles" %}</span><h3>Reflection, not a stress detector</h3><p>The goal is to add context and support self-awareness. A wearable cannot determine your mental state with certainty.</p></aside>
  </div>
